...
import { useAvifToJpg } from '@/hooks/useAvifToJpg';
...
const FEATURES = [
  ...
  },
  {
    ...
    description: 'Convert multiple AVIF images at once. Drag and drop a folder or select several files to process them all together.',
  },
  {
...
const FAQS = [
  {
    ...
    answer: 'AVIF (AV1 Image File Format) is a modern image format based on the AV1 video codec. It offers superior compression compared to JPEG and PNG while maintaining high quality, but lacks universal browser and software support.',
  },
  {
    question: 'Why convert AVIF to JPG?',
    answer: 'JPEG is universally supported across all devices, browsers, and software. Converting AVIF to JPG ensures your images can be viewed and edited anywhere, making them ideal for sharing or use in legacy applications.',
  },
  {
  ...
  },
  {
    ...
    answer: 'Yes, the tool supports batch conversion. You can drag and drop multiple AVIF files or select them all at once, and they will be converted sequentially.',
  },
  {
    question: 'What happens to transparency in AVIF images?',
    answer: 'JPEG does not support transparency. Any transparent areas in your AVIF images will be converted to white in the resulting JPG file.',
  },
];
...
export function AvifToJpg() {
  ...
  const softwareSchema = {
    ...
    description: 'Free online tool to convert AVIF images to JPG format. Client-side conversion with adjustable quality and batch processing support.',
  ...
  return (
    <SiteLayout toolName="AVIF to JPG Converter" category="converters">
          ...
          >
            <div className="text-gray-600 dark:text-gray-400 mb-4">
              {isConverting ? (
                ...
                <>
                  <p className="text-lg mb-2">Drag and drop AVIF files here</p>
