...
import { useBmpToJpg } from '@/hooks/useBmpToJpg';
...
const FEATURES = [
  ...
  },
  {
    ...
    description: 'Convert multiple BMP images at once. Drag and drop a folder or select several files to process them all together.',
  },
  {
...
const FAQS = [
  {
    ...
    answer: 'BMP (Bitmap) is a raster graphics image format developed by Microsoft. It stores images as uncompressed pixel data, resulting in high quality but very large file sizes compared to compressed formats like JPEG.',
  },
  {
    question: 'Why convert BMP to JPG?',
    answer: 'JPEG offers significant file size reduction through lossy compression while maintaining good visual quality. Converting BMP to JPG can reduce file sizes by 90% or more, making images easier to share, upload, and store.',
  },
  {
  ...
  },
  {
    ...
    answer: 'Yes, the tool supports batch conversion. You can drag and drop multiple BMP files or select them all at once, and they will be converted sequentially.',
  },
  {
    question: 'Will converting BMP to JPG reduce file size?',
    answer: 'Yes, significantly. BMP files are uncompressed and can be very large. Converting to JPEG with even high quality settings (90%) typically reduces file size by 80-95% while maintaining excellent visual quality.',
  },
];
...
export function BmpToJpg() {
  ...
  const softwareSchema = {
    ...
    description: 'Free online tool to convert BMP images to JPG format. Client-side conversion with adjustable quality and batch processing support.',
  ...
  return (
    <SiteLayout toolName="BMP to JPG Converter" category="converters">
          ...
          >
            <div className="text-gray-600 dark:text-gray-400 mb-4">
              {isConverting ? (
                ...
                <>
                  <p className="text-lg mb-2">Drag and drop BMP files here</p>
