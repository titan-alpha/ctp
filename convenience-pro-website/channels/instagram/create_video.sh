...
# Slide 1: Fade in tools one at a time
...
ffmpeg -loop 1 -t 0.5 -i blank.png \
       -loop 1 -t 0.5 -i slide1_step1.png \
       -loop 1 -t 0.5 -i slide1_step2.png \
...
# Slide 3: ConveniencePro fades in first, then C fades in behind
...
echo "Slide 3 animation created"
