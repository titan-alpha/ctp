#!/usr/bin/env python3
"""
Generate Instagram ad slides for ConveniencePro - Version 7
- C logo is BLUE at 25% transparency (instead of black)
- Color psychology backgrounds maintained
"""
...
def create_accumulated_tool_slides():
    ...
    print("✓ Created 3 tool slides (subtle warm background)")
...
def create_slide_2():
    ...
    img.save('slide2.png')
    print("✓ Slide 2 created (subtle blue background)")
...
def create_slide_3_elements():
    ...
    print("✓ Slide 3 created (BLUE C at 25% opacity behind text)")

if __name__ == '__main__':
    print("Generating Instagram ad slides (Version 7 - Blue C)...")
    print(f"- C Color: {C_COLOR} at 25% transparency")
    create_accumulated_tool_slides()
    create_slide_2()
    create_slide_3_elements()
    print("\nAll slides created with BLUE C logo!")
